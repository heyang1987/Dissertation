...
Various types of information can be collected/shared in an IoT system, such as location, photos, voice, and videos. From our interviews, we observe that participants show different levels of privacy concerns assuming a certain types of information about them is collected or shared. For example, some user will show high privacy concern if his/her photos or videos are shared, but not mind sharing his/her location. Below is an excerpt from an interview which highlights the importance of what information is collected/shared:\\
